...
#define push
    case 0b001010:
      ...
      if (i == 0) {
        ...
        fprintf(output, "0x%08X:\t%-25s\tMEM[0x%08X]{0x%08X}={}\n", R[29],
                instrucao, R[30], sp);
      } else {
        MEM32[sp >> 2] = R[i];
        R[30] -= 4;
      ...
      if (y == 0) {
        ...
        fprintf(
            ...
            R[29], instrucao, sp, MEM32[sp >> 2], R[w], R[x], u32toS(i),
            u32toS(w), u32toS(x));
      } else {
        MEM32[R[30] >> 2] = R[y];
        R[30] -= 4;
      ...
      if (z == 0) {
        ...
        fprintf(output,
                ...
                "s,%s,%s}\n",
                R[29], instrucao, sp, MEM32[sp >> 2], R[w], R[x], R[y],
        ...
        fprintf(output,
                ...
                "08X}={%s,%s,%s,%s,%s}\n",
                R[29], instrucao, sp, MEM32[sp >> 2], R[w], R[x], R[y], R[z],
