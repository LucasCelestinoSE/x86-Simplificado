...
#define l8
    case 0b011000:
      ...
      if (a % 4 == 0) {
        R[z] = MEM32[(R[x] + a) >> 2];
        sprintf(instrucao, "l8 r%u,[r%u%s%i]", z, x, (a >= 0) ? ("+") : (""),
                a);
...
#define l16
    case 0b011001:
      ...
      if (a % 2 == 0) {
        R[z] = MEM32[(R[x] + a) >> 1];
        sprintf(instrucao, "l16 r%u,[r%u%s%i]", z, x, (a >= 0) ? ("+") : (""),
                a);
...
#define call1
    ...
    case 0b010010:
      ...
      // Ov
      if (((R[x] & 0x80000000) >> 31) == ((xyl & 0x0003000) >> 15) &&
          (R[z] & 0x80000000) >> 31 != (R[x] & 0x80000000) >> 31) {
        sr = 0b00001000;
      } else {
        sr = sr & 0b11110111;
      };
    ...
    case 0b001010:
      ...
      if (w == 0) {
        ...
        fprintf(output, "0x%08X:\t%-25s\tMEM[0x%08X]{0x%08X}={%s}\n", R[29],
                instrucao, R[30] + 4, MEM32[sp >> 2], u32toSUper(i));
        break;
      } else {
        MEM32[R[30] >> 2] = R[w];
        R[30] -= 4;
      ...
      if (y == 0) {
        ...
        fprintf(
            ...
            R[29], instrucao, sp, MEM32[sp >> 2], MEM32[(sp - 4) >> 2],
            MEM32[(sp - 8) >> 2], u32toSUper(i), u32toSUper(w), u32toSUper(x));
        break;
      } else {
        MEM32[R[30] >> 2] = R[y];
        R[30] -= 4;
      ...
      if (z == 0) {
        ...
        fprintf(output,
                ...
                "s,%s,%s}\n",
                R[29], instrucao, sp, MEM32[sp >> 2], MEM32[(sp - 4) >> 2],
                MEM32[(sp - 8) >> 2], MEM32[(sp - 12) >> 2], u32toSUper(i),
                u32toSUper(w), u32toSUper(x), u32toSUper(y));
        break;
      } else {
        MEM32[R[30] >> 2] = R[z];
        R[30] -= 4;
        sprintf(instrucao, "push %s %s %s %s %s", u32toS(i), u32toS(w),
                u32toS(x), u32toS(y), u32toS(z));
        fprintf(output,
                "0x%08X:\t%-25s\tMEM[0x%08X]{0x%08X,0x%08X,0x%08X,0x%08X,0x%"
                "08X}={%s,%s,%s,%s,%s}\n",
                R[29], instrucao, sp, MEM32[sp >> 2], MEM32[(sp - 4) >> 2],
                MEM32[(sp - 8) >> 2], MEM32[(sp - 12) >> 2],
                MEM32[(sp - 16) >> 2], u32toSUper(i), u32toSUper(w),
                u32toSUper(x), u32toSUper(y), u32toSUper(z));
      };
      break;
#define pop
    case 0b001011:
      ...
      if (w == 0) {
        ...
        fprintf(output, "0x%08X:\t%-25s\t{%s}=MEM[0x%08X]{0x%08X}\n", R[29],
                instrucao, u32toSUper(i), R[30] - 4, R[i]);
        break;
      } else {
        R[30] += 4;
        R[w] = MEM32[R[30] >> 2];
      ...
      if (x == 0) {
        ...
        fprintf(output, "0x%08X:\t%-25s\t{%s,%s}=MEM[0x%08X]{0x%08X,0x%08X}\n",
                R[29], instrucao, u32toSUper(i), u32toSUper(w), R[30] - 8, R[i],
                R[w]);
        break;
      } else {
        R[30] += 4;
      ...
      if (y == 0) {
        ...
        fprintf(
            ...
            R[29], instrucao, u32toSUper(i), u32toSUper(w), u32toSUper(x),
            R[30] - 12, R[i], R[w], R[x]);
        break;
      } else {
        R[30] += 4;
      ...
      if (z == 0) {
        sprintf(instrucao, "pop %s %s %s %s", u32toS(i), u32toS(w), u32toS(x),
                u32toS(y));
        fprintf(output,
                "0x%08X:\t%-25s\t{%s,%s,%s,%s}=MEM[0x%08X]{0x%08X,0x%08X,0x%"
                "08X,0x%08X}\n",
                R[29], instrucao, u32toSUper(i), u32toSUper(w), u32toSUper(x),
                u32toSUper(y), R[30] - 16, R[i], R[w], R[x], R[y]);
        break;
      } else {
        R[30] += 4;
        R[z] = MEM32[R[30] >> 2];
        sprintf(instrucao, "pop %s %s %s %s %s", u32toS(i), u32toS(w),
                u32toS(x), u32toS(y), u32toS(z));
        fprintf(output,
                "0x%08X:\t%-25s\t{%s,%s,%s,%s,%s}=MEM[0x%08X]{0x%08X,0x%08X,0x%"
                "08X,0x%08X,0x%08X}\n",
                R[29], instrucao, u32toSUper(i), u32toSUper(w), u32toSUper(x),
                u32toSUper(y), u32toSUper(z), R[30] - 20, R[i], R[w], R[x],
                R[y], R[z]);
      };
      break;
#define s8
    case 0b011011:
      ...
      if (a % 4 == 0) {
        ...
        printf("Mod 0 MEM32:0x%08X, e:0x%08X,xyl:0x%08X \n",
               MEM32[(R[x] + a) >> 2], e, xyl);
        sprintf(instrucao, "s8 %s,[%s%s%i],%s", u32toS(z), u32toS(x),
                (a >= 0) ? ("+") : (""), a, u32toS(z));
        fprintf(output, "0x%08X:\t%-25s\tR%u=MEM[0x%08X]=%s=0x%02X\n", R[29],
                instrucao, z, (R[x] + a), u32toSUper(z),
                (MEM32[(R[x] + a) >> 2] >> 24));
      }
      if (a % 4 == 1) {
    ...
    case 0b011100:
      ...
      if (a % 2 == 0) {
        ...
        j = MEM32[(R[x] + a) >> 1];
        MEM32[(R[x] + a) >> 1] = e | xyl;
        printf("Mod 0(s16) MEM32(Antes): 0x%08X MEM32(Depois):0x%08X, "
               "e:0x%08X,xyl:0x%08X \n",
               j, MEM32[(R[x] + a << 1) >> 2], e, xyl);
        sprintf(instrucao, "s16 %s,[%s%s%i],%s", u32toS(z), u32toS(x),
                (a >= 0) ? ("+") : (""), a, u32toS(z));
        fprintf(output, "0x%08X:\t%-25s\tR%u=MEM[0x%08X]=%s=0x%04X\n", R[29],
                instrucao, z, (R[x] + a) << 1, u32toSUper(z),
                (MEM32[(R[x] + a) >> 1] >> 16));
      }
      if (a % 2 == 1) {
        ...
        j = MEM32[R[x] + a >> 1];
        MEM32[(R[x] + a) >> 1] = e | xyl;
        printf("Mod 1(s16) MEM32(Antes): 0x%08X MEM32(Depois):0x%08X, "
               "e:0x%08X,xyl:0x%08X \n",
               j, MEM32[(R[x] + a << 1) >> 2], e, xyl);
        sprintf(instrucao, "s16 %s,[%s%s%i],%s", u32toS(z), u32toS(x),
                (a >= 0) ? ("+") : (""), a, u32toS(z));
...
#define divs
      case 0b110:
        ...
        // zn
        //  Definindo ou limpando o bit 6 (0b01000000) com base no valor de
        //  temps
        if (R[z] == 0) {
          sr = sr | 0b01000000;
        } else {
...
#define div
      case 0b100:
        ...
        if (R[y] != 0) {
          ...
          // Definindo ou limpando o bit 3 (0b00001000) com base no valor de
          // R[z]
          // ZD
          if (R[y] == 0) {
            sr = sr | 0b00100000;
